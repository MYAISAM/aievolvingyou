  ...
  return (
    <div style={{
      ...
      <p style={{
        ...
        Talent leads, and Procurement teams who need to ask better questions.
      </p>
      ...
      <ul style={{
        ...
        {[
          ...
          <li key={i} style={{
            ...
            gap: 8, fontSize: "0.82rem",
            color: inkMid, lineHeight: 1.55,
          }}>
            <span style={{ color: green, fontWeight: 700, marginTop: 1, flexShrink: 0 }}>
              ✓
            </span>
            {item}
          </li>
      ...
      <div style={{
        ...
        <div>
          ...
          <span style={{
            fontSize: "0.78rem", color: inkMid, marginLeft: 6,
          }}>
            one-time + VAT, instant download
          </span>
        </div>
        <a
