...
export default function ThankYouBiasAudit() {
  return (
    <main
      style={{
        maxWidth: 720,
    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            ...
            is ready to download. Work through it with whoever owns AI
      ...
      >
        ...
        >
          7 audit categories, 40 review questions, remediation prompts, and an
