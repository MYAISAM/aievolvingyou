...
const articles = [
  ...
  {
    bucket: "Interview Resources",
    title: "Why \"I'm a good communicator\" is killing your applications",
  ...
  },
  {
    ...
    excerpt: "AI is the best interview prep tool available right now. Most people are using it wrong. Here's the difference between using it as a thinking partner and using it as a script.",
    href: "#",
    available: true,
  },
  {
